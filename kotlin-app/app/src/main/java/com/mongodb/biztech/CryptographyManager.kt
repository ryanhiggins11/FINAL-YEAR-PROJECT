...
interface CryptographyManager {
     ...
     */
    fun encryptPassword(plaintext: String, cipher: Cipher): CiphertextWrapper

    /**
     * The Cipher created with [getInitializedCipherForDecryption] is used here
     */
    fun decryptPassword(ciphertext: ByteArray, cipher: Cipher): String
...
private class CryptographyManagerImpl : CryptographyManager {
    ...
    override fun encryptPassword(plaintext: String, cipher: Cipher): CiphertextWrapper {
        val ciphertext = cipher.doFinal(plaintext.toByteArray(Charset.forName("UTF-8")))
        return CiphertextWrapper(ciphertext, cipher.iv)
    }

    override fun decryptPassword(ciphertext: ByteArray, cipher: Cipher): String {
